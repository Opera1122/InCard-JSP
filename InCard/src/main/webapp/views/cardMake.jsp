	...
	<body>
		...
		<div id="wrapper">
			<div id="background">
				...
				<div id="share">
					 지금 바로 전달하세요.
					 <a href="#" onclick="clip(); return false;"><img src="../images/btn_img/kakaotalk_sharing_btn_small.png"></a>
					 <a href="#" onclick="clip(); return false;"><img src="../images/btn_img/share_link.png"></a>
